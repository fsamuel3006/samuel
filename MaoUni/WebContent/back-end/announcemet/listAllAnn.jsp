...
<%--     <link rel="stylesheet" href="<%=request.getContextPath()%>/back-end/resources/css/hidden_menu.css"> --%>
<%--     <link rel="stylesheet" href="<%=request.getContextPath()%>/back-end/resources/css/hidden_menu2.css"> --%>
...
<%--     <script src="<%=request.getContextPath()%>/back-end/js/hidden_menu3.js"></script> --%>
<%--     <script src="<%=request.getContextPath()%>/back-end/js/hidden_menu4.js"></script> --%>
</body>
</html>