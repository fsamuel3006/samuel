...
<%
  FunctionVO functionVO = (FunctionVO) request.getAttribute("oneFunction");
%>
...
</head> <div id="wrapper" style="margin-left: 120px;height: auto;">
...
<!--請看這行最右邊-->  <a class="btsp" href="Item_select_page.jsp">新增功能</a>  <!-- 這行是商城管理的標題，可以自行設定，還有href可以自行設定跳轉的頁面 -->
...
<FORM METHOD="post" ACTION="<%= request.getContextPath()%>/backstage_function/functionServlet" name="form1">
<table>
	<tr>
		<td>功能:</td>
		<td><input type="TEXT" name="id" size="45" 
			 value="<%= (functionVO==null)? "" : functionVO.getId()%>" /></td>
	</tr>
	<tr>
		<td>功能名稱:</td>
		<td><input type="TEXT" name="name" size="45"
			 value="<%= (functionVO==null)? "" : functionVO.getName()%>" /></td>
	</tr>
