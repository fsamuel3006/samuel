            ...
            <div id="content" style="height: 100%;">
                <nav class="navbar navbar-light navbar-expand bg-white mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <p style="width: 266px;height: 5px;margin-top:30px;margin-left:-13px;font-weight:bold;"><a class="btsp" href="Item_select_page.jsp">會員資料管理</a></p>
        ...
        <div class="card-body" style="height: auto;">
            ...
            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                <table class="table my-0" id="dataTable">
                    <thead>
                        <tr>
                            <th style="width: 77px;text-align: center;font-size:2;">會員編號</th>
                            <th style="width: 77px;text-align: center;font-size:2;">姓名</th>
                            <th style="width: 112.5px;text-align: center;font-size:2;">信箱</th>
                            <th style="width: 91.5px;text-align: center;font-size:2;">身分證</th>
                            <th style="width: 91.5px;text-align: center;font-size:2;">性別</th>
...
<%-- 						<c:forEach var="memberVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>"> --%>
							...
							<tr style="width: 70px;text-align: center;">
								<td style="width: 90px;text-align: center;font-size:1">${memberVO.memId}</td>
								<td style="width: 90px;text-align: center;font-size:1">${memberVO.memName}</td>
								<td style="width: 100.5px;text-align: center;font-size:1">${memberVO.memEmail}</td>
								<td style="width: 91.5px;text-align: center;font-size:1">${memberVO.memIdenity}</td>
								<td style="width: 91.5px;text-align: center;font-size:1">${memberVO.memGender}</td>
								<td style="width: 91.5px;text-align: center;font-size:1">${memberVO.memPh}</td>
								<td style="width: 91.5px;text-align: center;font-size:1">${memberVO.memAddres}</td>
